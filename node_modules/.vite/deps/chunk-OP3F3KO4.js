...
var OutlinedInput = React15.forwardRef(function OutlinedInput2(inProps, ref) {
  ...
  return (0, import_jsx_runtime12.jsx)(InputBase_default, {
    ...
    renderSuffix: (state) => (0, import_jsx_runtime12.jsx)(NotchedOutlineRoot2, {
      ...
      label: label != null && label !== "" && fcs.required ? _React$Fragment || (_React$Fragment = (0, import_jsx_runtime12.jsxs)(React15.Fragment, {
        children: [label, " ", "*"]
      })) : label,
  ...
  return (0, import_jsx_runtime29.jsx)(FormControlContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime29.jsx)(InputAdornmentRoot, {
      ...
      children: typeof children === "string" && !disableTypography ? (0, import_jsx_runtime29.jsx)(Typography_default, {
        color: "textSecondary",
        children
      }) : (0, import_jsx_runtime29.jsxs)(React34.Fragment, {
...
var PopperTooltip = React35.forwardRef(function PopperTooltip2(props, forwardedRef) {
  ...
  const [resolvedAnchorElement, setResolvedAnchorElement] = React35.useState(resolveAnchorEl2(anchorEl));
  React35.useEffect(() => {
...
var Cancel_default = createSvgIcon((0, import_jsx_runtime37.jsx)("path", {
...
var Chip = React45.forwardRef(function Chip2(inProps, ref) {
  ...
  if (onDelete) {
    ...
    }) : (0, import_jsx_runtime38.jsx)(Cancel_default, {
  ...
  return (0, import_jsx_runtime38.jsxs)(ChipRoot, {
    as: component,
    className: clsx_default(classes.root, className),
    ...
    ...moreProps,
    ...other,
    children: [avatar || icon, (0, import_jsx_runtime38.jsx)(ChipLabel, {
...
true ? Dialog.propTypes = {
   ...
   * @default true
   */
  "aria-modal": import_prop_types39.default.oneOfType([import_prop_types39.default.oneOf(["false", "true"]), import_prop_types39.default.bool]),
  /**
   * A backdrop component. This prop enables custom backdrop rendering.
   * @deprecated Use `slots.backdrop` instead. While this prop currently works, it will be removed in the next major version.
   * Use the `slots.backdrop` prop to make your application ready for the next version of Material UI.
...
//# sourceMappingURL=chunk-OP3F3KO4.js.map
