...
import {
  ...
  validateSections,
  validateTime
} from "./chunk-CKKGTN2S.js";
import {
  LocalizationProvider
} from "./chunk-LL76DZFS.js";
import {
  Fade_default,
  IconButton_default,
  Typography_default,
  useMediaQuery_default
} from "./chunk-AAJW5UJX.js";
import {
...
import {
  useThemeProps
} from "./chunk-7WY42NL4.js";
import "./chunk-S72AY76O.js";
import {
  alpha,
  capitalize,
  composeClasses,
...
var TimeField = React18.forwardRef(function TimeField2(inProps, inRef) {
...
function TimePickerToolbar(inProps) {
  ...
  return (0, import_jsx_runtime14.jsxs)(TimePickerToolbarRoot, _extends({
    landscapeDirection: "row",
    ...
    children: [(0, import_jsx_runtime14.jsxs)(TimePickerToolbarHourMinuteLabel, {
      className: classes.hourMinuteLabel,
      ownerState,
      children: [arrayIncludes(views, "hours") && (0, import_jsx_runtime14.jsx)(PickersToolbarButton, {
        tabIndex: -1,
        variant: "h3",
        onClick: () => onViewChange("hours"),
        selected: view === "hours",
        value: value ? formatHours(value) : "--"
      }), arrayIncludes(views, ["hours", "minutes"]) && separator, arrayIncludes(views, "minutes") && (0, import_jsx_runtime14.jsx)(PickersToolbarButton, {
        tabIndex: -1,
        variant: "h3",
        onClick: () => onViewChange("minutes"),
        selected: view === "minutes",
        value: value ? utils.format(value, "minutes") : "--"
      }), arrayIncludes(views, ["minutes", "seconds"]) && separator, arrayIncludes(views, "seconds") && (0, import_jsx_runtime14.jsx)(PickersToolbarButton, {
        variant: "h3",
        onClick: () => onViewChange("seconds"),
        selected: view === "seconds",
        value: value ? utils.format(value, "seconds") : "--"
      })]
    }), showAmPmControl && (0, import_jsx_runtime14.jsxs)(TimePickerToolbarAmPmSelection, {
...
function PickersPopper(inProps) {
  ...
  return (0, import_jsx_runtime15.jsx)(Popper, _extends({}, popperProps, {
    children: ({
      TransitionProps,
      placement: popperPlacement
    }) => (0, import_jsx_runtime15.jsx)(FocusTrap, _extends({
      open,
...
var useOpenState = ({
  ...
  const isControllingOpenProp = React25.useRef(typeof open === "boolean").current;
  const [openState, setIsOpenState] = React25.useState(false);
  React25.useEffect(() => {
  ...
  const setIsOpen = React25.useCallback((newIsOpen) => {
    if (!isControllingOpenProp) {
...
var usePickerValue = ({
  ...
  } = React26.useRef(inDefaultValue);
  const {
    current: isControlled
  } = React26.useRef(inValueWithoutRenderTimezone !== void 0);
  const [previousTimezoneProp, setPreviousTimezoneProp] = React26.useState(timezoneProp);
  if (true) {
    React26.useEffect(() => {
  ...
  const [dateState, setDateState] = React26.useState(() => {
    let initialValue;
  ...
  const viewValue = React26.useMemo(() => valueManager.cleanValue(utils, dateState.draft), [utils, valueManager, dateState.draft]);
  const viewResponse = {
    value: viewValue,
...
var usePickerViews = ({
  ...
  const timeViewsCount = React27.useMemo(() => views.reduce((acc, viewForReduce) => {
...
var useDesktopPicker = (_ref) => {
  ...
  if (hasUIView) {
    fieldProps.InputProps = _extends({}, fieldProps.InputProps, {
      ...
      [`${inputAdornmentProps.position}Adornment`]: (0, import_jsx_runtime20.jsx)(InputAdornment, _extends({}, inputAdornmentProps, {
        children: (0, import_jsx_runtime20.jsx)(OpenPickerButton, _extends({}, openPickerButtonProps, {
  ...
  const renderPicker = () => (0, import_jsx_runtime20.jsxs)(PickersProvider, {
    ...
    })), (0, import_jsx_runtime20.jsx)(PickersPopper, _extends({
      role: "dialog",
...
function ClockPointer(inProps) {
  ...
  const previousType = React35.useRef(type);
  React35.useEffect(() => {
  ...
  return (0, import_jsx_runtime21.jsx)(ClockPointerRoot, _extends({
    style: getAngleStyle(),
    className: clsx_default(classes.root, className),
    ownerState
  }, other, {
    children: (0, import_jsx_runtime21.jsx)(ClockPointerThumb, {
      ownerState,
...
function Clock(inProps) {
  ...
  const utils = useUtils();
  const translations = usePickersTranslations();
  const isMoving = React36.useRef(false);
  ...
  const hasSelected = React36.useMemo(() => {
    if (type === "hours") {
      return true;
    }
  ...
  return (0, import_jsx_runtime22.jsxs)(ClockRoot, {
    ...
    children: [(0, import_jsx_runtime22.jsxs)(ClockClock, {
      ...
      children: [(0, import_jsx_runtime22.jsx)(ClockSquareMask, {
      ...
      }), !isSelectedTimeDisabled && (0, import_jsx_runtime22.jsxs)(React36.Fragment, {
        children: [(0, import_jsx_runtime22.jsx)(ClockPin, {
          className: classes.pin
        }), value != null && (0, import_jsx_runtime22.jsx)(ClockPointer, {
          type,
          viewValue,
          isInner: isPointerInner,
          hasSelected
        })]
      }), (0, import_jsx_runtime22.jsx)(ClockWrapper, {
    ...
    }), ampm && ampmInClock && (0, import_jsx_runtime22.jsxs)(React36.Fragment, {
      children: [(0, import_jsx_runtime22.jsx)(ClockAmButton, {
        onClick: readOnly ? void 0 : () => handleMeridiemChange("am"),
        disabled: disabled || meridiemMode === null,
        ownerState,
        className: classes.amButton,
        title: formatMeridiem(utils, "am"),
        children: (0, import_jsx_runtime22.jsx)(ClockMeridiemText, {
          variant: "caption",
          className: classes.meridiemText,
          children: formatMeridiem(utils, "am")
        })
      }), (0, import_jsx_runtime22.jsx)(ClockPmButton, {
        disabled: disabled || meridiemMode === null,
        onClick: readOnly ? void 0 : () => handleMeridiemChange("pm"),
        ownerState,
...
var TimeClock = React40.forwardRef(function TimeClock2(inProps, ref) {
  const utils = useUtils();
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimeClock"
  ...
  const isTimeDisabled = React40.useCallback((rawValue, viewType) => {
  ...
  const viewProps = React40.useMemo(() => {
    switch (view) {
      case "hours": {
  ...
  return (0, import_jsx_runtime25.jsxs)(TimeClockRoot, _extends({
    ref,
    className: clsx_default(classes.root, className),
    ownerState
  }, other, {
    children: [(0, import_jsx_runtime25.jsx)(Clock, _extends({
      ...
      disabled,
      readOnly
    }, viewProps)), showViewSwitcher && (0, import_jsx_runtime25.jsx)(TimeClockArrowSwitcher, {
...
var DigitalClock = React41.forwardRef(function DigitalClock2(inProps, ref) {
  const utils = useUtils();
  ...
  const translations = usePickersTranslations();
  const now = useNow(timezone);
  const ownerState = React41.useMemo(() => _extends({}, props, {
  ...
  const isTimeDisabled = React41.useCallback((valueToCheck) => {
    const isAfter = createIsAfterIgnoreDatePart(disableIgnoringDatePartForTimeValidation, utils);
    const containsValidTime = () => {
  ...
  const timeOptions = React41.useMemo(() => {
    const result = [];
  ...
  return (0, import_jsx_runtime26.jsx)(DigitalClockRoot, _extends({
    ref: handleRef,
    className: clsx_default(classes.root, className),
    ownerState
  }, other, {
    children: (0, import_jsx_runtime26.jsx)(DigitalClockList, {
      ref: listRef,
      role: "listbox",
      ...
      children: timeOptions.map((option, index) => {
        ...
        return (0, import_jsx_runtime26.jsx)(ClockItem, _extends({
...
var MultiSectionDigitalClockSection = React42.forwardRef(function MultiSectionDigitalClockSection2(inProps, ref) {
  const containerRef = React42.useRef(null);
  const handleRef = useForkRef(ref, containerRef);
  const previousActive = React42.useRef(null);
  const props = useThemeProps({
    props: inProps,
    name: "MuiMultiSectionDigitalClockSection"
  });
  ...
  const ownerState = React42.useMemo(() => _extends({}, props, {
    alreadyRendered: !!containerRef.current
  }), [props]);
  ...
  return (0, import_jsx_runtime27.jsx)(MultiSectionDigitalClockSectionRoot, _extends({
    ref: handleRef,
    className: clsx_default(classes.root, className),
    ownerState,
    ...
    children: items.map((option, index) => {
      ...
      const tabIndex = focusedOptionIndex === index || focusedOptionIndex === -1 && index === 0 ? 0 : -1;
      return (0, import_jsx_runtime27.jsx)(DigitalClockSectionItem, _extends({
...
var MultiSectionDigitalClock = React43.forwardRef(function MultiSectionDigitalClock2(inProps, ref) {
  const utils = useUtils();
  const isRtl = useRtl();
  const props = useThemeProps({
    props: inProps,
  ...
  const translations = usePickersTranslations();
  const now = useNow(timezone);
  const timeSteps = React43.useMemo(() => _extends({
    hours: 1,
    minutes: 5,
    seconds: 5
  ...
  const buildViewProps = React43.useCallback((viewToBuild) => {
    switch (viewToBuild) {
      case "hours": {
        return {
          onChange: (hours) => {
  ...
  const viewsToRender = React43.useMemo(() => {
    if (!isRtl) {
      return views;
    }
  ...
  const viewTimeOptions = React43.useMemo(() => {
  ...
  return (0, import_jsx_runtime28.jsx)(MultiSectionDigitalClockRoot, _extends({
    ref,
    className: clsx_default(classes.root, className),
    ownerState,
    role: "group"
  }, other, {
    children: viewsToRender.map((timeView) => (0, import_jsx_runtime28.jsx)(MultiSectionDigitalClockSection, {
...
function PickersModalDialog(props) {
  ...
  return (0, import_jsx_runtime30.jsx)(Dialog, _extends({
    open,
    onClose: onDismiss
    ...
    children: (0, import_jsx_runtime30.jsx)(PickersModalDialogContent, {
      children
    })
  }));
}
...
var useMobilePicker = (_ref) => {
  ...
  const handleFieldRef = useForkRef(fieldRef, fieldProps.unstableFieldRef);
  const renderPicker = () => (0, import_jsx_runtime31.jsxs)(PickersProvider, {
    contextValue,
    localeText,
    children: [(0, import_jsx_runtime31.jsx)(Field, _extends({}, fieldProps, {
      slots: slotsForField,
      slotProps,
      unstableFieldRef: handleFieldRef
    })), (0, import_jsx_runtime31.jsx)(PickersModalDialog, _extends({}, actions, {
      open,
      slots,
      slotProps,
      children: (0, import_jsx_runtime31.jsx)(Layout, _extends({}, layoutProps, slotProps == null ? void 0 : slotProps.layout, {
        slots,
        slotProps,
        children: renderCurrentView()
      }))
...
// node_modules/@mui/x-date-pickers/MobileTimePicker/MobileTimePicker.js
var MobileTimePicker = React48.forwardRef(function MobileTimePicker2(inProps, ref) {
  var _a, _b;
  const translations = usePickersTranslations();
  const utils = useUtils();
...
var TimePicker = React49.forwardRef(function TimePicker2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimePicker"
  });
  ...
  if (isDesktop) {
    return (0, import_jsx_runtime32.jsx)(DesktopTimePicker, _extends({
      ref
    }, other));
  }
  return (0, import_jsx_runtime32.jsx)(MobileTimePicker, _extends({
    ref
  }, other));
});
