...
const ConfirmationDialog: React.FC<ConfirmationDialogProps> = (props) => (
  <Dialog open={props.open} onClose={props.handleClose} sx={{ '& .MuiDialog-paper': { borderRadius: '16px' } }}>
    ...
    <DialogActions sx={{ justifyContent: 'center', padding: '16px' }}>
      <Button onClick={props.handleClose} sx={{ color: '#1976d2', fontWeight: 'bold' }}>
      Cancel
      </Button>
      <Button onClick={props.handleConfirm} color="error" variant="contained" sx={{ borderRadius: '20px', fontWeight: 'bold' }}>
      Delete
      </Button>
    </DialogActions>
</Dialog>
